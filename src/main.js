  ...
  if (!_) {
    ...
    for (let n2 = 0;n2 < 5; n2++) {
      ...
      for (let t3 = 0;t3 < r2.length; t3++) {
        const e3 = r2[t3];
        _[e3] === undefined && (_[e3] = t3);
      }
    }
  }
}
var w = typeof Uint8Array != "undefined";
var T = !(!(f && l && l.brands.length > 0) && (p().indexOf("Trident") != -1 || p().indexOf("MSIE") != -1)) && typeof btoa == "function";
var A = /[-_.]/g;
var b = { "-": "+", _: "/", ".": "=" };
function k(t2) {
  return b[t2] || "";
...
function x(t2) {
  return w && t2 != null && t2 instanceof Uint8Array;
}
var L = {};
function R() {
...
function I(t2) {
  C(L);
  var e2 = t2.g;
  return (e2 = e2 == null || x(e2) ? e2 : typeof e2 == "string" ? S(e2) : null) == null ? e2 : t2.g = e2;
}
var F = class {
  h() {
  ...
  constructor(t2, e2) {
    if (C(e2), this.g = t2, t2 != null && t2.length === 0)
...
var B = typeof Symbol == "function" && typeof Symbol() == "symbol";
...
var j = G("jas", undefined, true);
var V = G(undefined, "0di");
var X = G(undefined, "1oa");
var H = G(undefined, Symbol());
var W = G(undefined, "0ub");
var z = G(undefined, "0ubs");
var K = G(undefined, "0ubsb");
var Y = G(undefined, "0actk");
var q = G("m_m", "Pa", true);
var $ = G();
...
var ot = {};
function at(t2, e2) {
  return e2 === undefined ? t2.h !== ct && !!(2 & (0 | t2.v[Q])) : !!(2 & e2) && t2.h !== ct;
}
var ct = {};
function ht(t2, e2) {
  if (t2 != null) {
...
var dt = {};
function pt(t2) {
  return 128 & t2 ? dt : undefined;
}
function gt(t2) {
  return t2.Na = true, t2;
}
var mt = gt((t2) => typeof t2 == "number");
var yt = gt((t2) => typeof t2 == "string");
var _t = gt((t2) => typeof t2 == "boolean");
var vt = typeof t.BigInt == "function" && typeof t.BigInt(0) == "bigint";
function Et(t2) {
  var e2 = t2;
  if (yt(e2)) {
...
var At = vt ? BigInt(Number.MIN_SAFE_INTEGER) : undefined;
var bt = Number.MAX_SAFE_INTEGER.toString();
var kt = vt ? BigInt(Number.MAX_SAFE_INTEGER) : undefined;
function St(t2, e2) {
...
var xt = typeof Uint8Array.prototype.slice == "function";
var Lt;
var Rt = 0;
var It = 0;
function Ft(t2) {
...
var Xt = typeof BigInt == "function" ? BigInt.asIntN : undefined;
var Ht = typeof BigInt == "function" ? BigInt.asUintN : undefined;
...
function ne(t2) {
  ...
  if (typeof t2 == "string" && t2)
    ...
    return;
  return zt(t2) ? t2 >>> 0 : undefined;
}
function re(t2) {
  const e2 = t2.length;
  return (t2[0] === "-" ? e2 < 20 || e2 === 20 && t2 <= "-9223372036854775808" : e2 < 19 || e2 === 19 && t2 <= "9223372036854775807") ? t2 : (Gt(t2), Bt(Rt, It));
}
function ie(t2) {
  if (t2 = Kt(t2), !Wt(t2)) {
    Mt(t2);
    var e2 = Rt, n2 = It;
    (t2 = 2147483648 & n2) && (n2 = ~n2 >>> 0, (e2 = 1 + ~e2 >>> 0) == 0 && (n2 = n2 + 1 >>> 0)), t2 = typeof (e2 = Ct(e2, n2)) == "number" ? t2 ? -e2 : e2 : t2 ? "-" + e2 : e2;
  }
  return t2;
}
function se(t2) {
  var e2 = Kt(Number(t2));
  return Wt(e2) ? String(e2) : ((e2 = t2.indexOf(".")) !== -1 && (t2 = t2.substring(0, e2)), re(t2));
}
function oe(t2) {
  var e2 = Kt(Number(t2));
  return Wt(e2) ? Et(e2) : ((e2 = t2.indexOf(".")) !== -1 && (t2 = t2.substring(0, e2)), D() ? Et(Xt(64, BigInt(t2))) : Et(re(t2)));
}
function ae(t2) {
...
function ce(t2) {
  const e2 = typeof t2;
  return t2 == null ? t2 : e2 === "bigint" ? Et(Xt(64, t2)) : te(t2) ? e2 === "string" ? oe(t2) : ae(t2) : undefined;
}
function he(t2) {
  if (typeof t2 != "string")
    throw Error();
...
function fe(t2, e2, n2, r2) {
  return t2 != null && t2[q] === ot ? t2 : Array.isArray(t2) ? ((r2 = (n2 = 0 | t2[Q]) | 32 & r2 | 2 & r2) !== n2 && rt(t2, r2), new e2(t2)) : (n2 ? 2 & r2 ? ((t2 = e2[V]) || (it((t2 = new e2).v), t2 = e2[V] = t2), e2 = t2) : e2 = new e2 : e2 = undefined, e2);
}
function de(t2, e2, n2) {
  if (e2)
    ...
    e2 = ce(t2);
  return (t2 = e2) == null ? n2 ? Yt : undefined : t2;
}
var pe = {};
var ge = function() {
  try {
...
var Ee = class extends ye {
  ...
  set(t2, e2) {
    return ve(this), (t2 = this.S(t2, true, false)) == null ? this : e2 == null ? (super.delete(t2), this) : super.set(t2, this.fa(e2, true, true, this.K, false, this.J));
  }
  Ma(t2) {
...
var Ae;
function be() {
  return Ae ||= new Ee(it([]), undefined, undefined, undefined, pe);
}
function ke(t2) {
  return H ? t2[H] : undefined;
}
function Se(t2, e2) {
  for (const n2 in t2)
    !isNaN(n2) && e2(t2, +n2, t2[n2]);
}
Ee.prototype.toJSON = undefined;
var xe = class {
};
var Le = { Ka: true };
function Re(t2, e2) {
...
function Me(t2) {
  switch (typeof t2) {
    ...
    case "object":
      if (Array.isArray(t2)) {
        var e2 = 0 | t2[Q];
        return t2.length === 0 && 1 & e2 ? undefined : Ie(t2, e2, Me);
      }
      if (t2 != null && t2[q] === ot)
        return Oe(t2);
      if (t2 instanceof F) {
        if ((e2 = t2.g) == null)
          ...
          if (T) {
            ...
            n2 === undefined && (n2 = 0), E(), n2 = y[n2], r2 = Array(Math.floor(e2.length / 3)), i2 = n2[64] || "";
            let t3 = 0, h2 = 0;
      ...
      return t2 instanceof Ee ? t2 = t2.size !== 0 ? t2.V(Fe) : undefined : undefined;
  }
  return t2;
}
var Pe;
...
function De(t2, e2) {
  ...
  if (Array.isArray(t2)) {
    var n2 = 0 | t2[Q];
    return t2.length === 0 && 1 & n2 ? undefined : Be(t2, n2, e2);
  }
  if (t2 != null && t2[q] === ot)
    return je(t2);
  if (t2 instanceof Ee) {
    ...
    if (n2 = it(t2.V()), t2.K)
      for (t2 = 0;t2 < n2.length; t2++) {
        const r2 = n2[t2];
        let i2 = r2[1];
        i2 = i2 == null || typeof i2 != "object" ? undefined : i2 != null && i2[q] === ot ? je(i2) : Array.isArray(i2) ? Be(i2, 0 | i2[Q], !!(32 & e2)) : undefined, r2[1] = i2;
      }
    return n2;
  }
  return t2 instanceof F ? t2 : undefined;
}
...
function He(t2) {
  if (t2.h !== ct)
    return false;
  var e2 = t2.v;
  return nt(e2 = Ve(e2, 0 | e2[Q]), 2048), t2.v = e2, t2.h = undefined, t2.m = undefined, true;
}
function We(t2) {
...
function ze(t2, e2) {
  e2 === undefined && (e2 = 0 | t2[Q]), 32 & e2 && !(4096 & e2) && rt(t2, 4096 | e2);
}
...
function $e(t2, e2, n2, r2, i2) {
  if ((e2 = Je(t2.v, e2, n2, i2)) !== null || r2 && t2.m !== ct)
    return e2;
}
...
function Qe(t2, e2, n2, r2, i2) {
  ...
  return s2 <= o2 ? (t2[s2] = r2, e2) : (r2 !== undefined && (n2 >= (o2 = (e2 ??= 0 | t2[Q]) >> 14 & 1023 || 536870912) ? r2 != null && (t2[o2 + (i2 ? 0 : -1)] = { [n2]: r2 }) : t2[s2] = r2), e2);
}
function tn() {
  return lt === undefined ? 2 : 4;
}
function en(t2, e2, n2, r2, i2) {
  let s2 = t2.v, o2 = 0 | s2[Q];
  r2 = at(t2, o2) ? 1 : r2, i2 = !!i2 || r2 === 3, r2 === 2 && He(t2) && (s2 = t2.v, o2 = 0 | s2[Q]);
...
function nn(t2, e2, n2, r2, i2, s2, o2, a2) {
  let c2 = e2;
  return s2 === 1 || s2 === 4 && (2 & e2 || !(16 & e2) && 32 & r2) ? on(e2) || ((e2 |= !t2.length || o2 && !(4096 & e2) || 32 & r2 && !(4096 & e2 || 16 & e2) ? 2 : 256) !== c2 && rt(t2, e2), Object.freeze(t2)) : (s2 === 2 && on(e2) && (t2 = Vt(t2), c2 = 0, e2 = An(e2, r2), r2 = Qe(n2, r2, i2, t2)), on(e2) || (a2 || (e2 |= 16), e2 !== c2 && rt(t2, e2))), 2 & e2 || !(4096 & e2 || 16 & e2) || ze(n2, r2), t2;
}
...
function hn(t2, e2, n2, r2) {
  We(t2), Qe(t2 = t2.v, 0 | t2[Q], e2, (r2 === "0" ? Number(n2) === 0 : n2 === r2) ? undefined : n2);
}
...
function ln(t2, e2) {
  var n2 = Cs;
  return pn(fn(t2 = t2.v), t2, undefined, n2) === e2 ? e2 : -1;
}
function fn(t2) {
  if (B)
    return t2[X] ?? (t2[X] = new Map);
  if (X in t2)
    return t2[X];
  const e2 = new Map;
...
function dn(t2, e2, n2, r2, i2) {
  ...
  return o2 !== r2 && (o2 && (e2 = Qe(t2, e2, o2, undefined, i2)), s2.set(n2, r2)), e2;
}
function pn(t2, e2, n2, r2, i2) {
  ...
  for (let t3 = 0;t3 < r2.length; t3++) {
    const o2 = r2[t3];
    Je(e2, o2, i2) != null && (s2 !== 0 && (n2 = Qe(e2, n2, s2, undefined, i2)), s2 = o2);
  }
...
function _n(t2, e2, n2, r2, i2, s2, o2, a2) {
  var c2 = at(t2, n2);
  s2 = c2 ? 1 : s2, o2 = !!o2 || s2 === 3, c2 = a2 && !c2, (s2 === 2 || c2) && He(t2) && (n2 = 0 | (e2 = t2.v)[Q]);
  ...
  if (u2 !== h2 && (rt(t2, u2), 2 & u2 && Object.freeze(t2)), c2 && !(8 & u2 || !t2.length && (s2 === 1 || s2 === 4 && (2 & u2 || !(16 & u2) && 32 & n2)))) {
...
function bn(t2, e2, n2, r2) {
  var i2 = r2;
  We(t2), t2 = _n(t2, r2 = t2.v, 0 | r2[Q], n2, e2, 2, true), i2 = i2 != null ? i2 : new n2, t2.push(i2), e2 = n2 = t2 === tt ? 7 : 0 | t2[Q], (i2 = at(i2)) ? (n2 &= -9, t2.length === 1 && (n2 &= -4097)) : n2 |= 4096, n2 !== e2 && rt(t2, n2), i2 || ze(r2);
}
function kn(t2, e2, n2) {
  return ee($e(t2, e2, undefined, n2));
}
function Sn(t2, e2) {
  return $e(t2, e2, undefined, undefined, $t) ?? 0;
}
...
function In(t2, e2, n2) {
  {
    ...
    if (n2 == null)
      ...
      for (i2 || (t2 = 0), s2 || (n2 = Vt(n2), r2 = 0, t2 = An(t2, a2), s2 = false), t2 |= 5, t2 |= (4 & t2 ? 512 & t2 ? 512 : 1024 & t2 ? 1024 : 0 : undefined) ?? 1024, i2 = 0;i2 < n2.length; i2++) {
...
function Dn(t2) {
  ...
  const s2 = e2[n2 + 2];
  return e2 = e2[n2 + 3], Gn(t2, t2.g + 4), t2 = 2 * ((i2 = (r2 << 0 | i2 << 8 | s2 << 16 | e2 << 24) >>> 0) >> 31) + 1, r2 = i2 >>> 23 & 255, i2 &= 8388607, r2 == 255 ? i2 ? NaN : t2 * (1 / 0) : r2 == 0 ? 0.000000000000000000000000000000000000000000001401298464324817 * t2 * i2 : t2 * Math.pow(2, r2 - 150) * (i2 + 8388608);
}
function Bn(t2) {
  return Nn(t2);
}
...
function Vn(t2, e2) {
  if (e2 == 0)
    return R();
  var n2 = jn(t2, e2);
  return t2.Y && t2.j ? n2 = t2.h.subarray(n2, n2 + e2) : (t2 = t2.h, n2 = n2 === (e2 = n2 + e2) ? new Uint8Array(0) : xt ? t2.slice(n2, e2) : new Uint8Array(t2.subarray(n2, e2))), n2.length == 0 ? R() : new F(n2, L);
}
var Xn = [];
function Hn(t2, e2, n2, r2) {
  if (Qn.length) {
    ...
    if (Xn.length) {
      ...
      t2 = new class {
        ...
        init(t3, e3, n3, { Y: r3 = false, ea: i2 = false } = {}) {
          this.Y = r3, this.ea = i2, t3 && (t3 = Pn(t3, this.ea), this.h = t3.buffer, this.j = t3.g, this.m = e3 || 0, this.l = n3 !== undefined ? this.m + n3 : this.h.length, this.g = this.m);
        }
        clear() {
...
function gr(t2, e2, n2, r2) {
  n2 != null && (e2 = fr(t2, e2), r2(n2, t2), dr(t2, e2));
}
function mr() {
  const t2 = class {
    constructor() {
...
var Lr = class {
  constructor(t2, e2) {
    this.v = Ue(t2, e2, undefined, 2048);
  }
  toJSON() {
    return Oe(this);
  }
  j() {
    ...
    if (B && r2 && e2[r2]?.[n2] != null && U(W, 3), e2 = t2.g, $ && H && $ === undefined && (r2 = (n2 = this.v)[H]) && (r2 = r2.da))
      try {
        r2(n2, e2, Le);
      } catch (t3) {
        u(t3);
...
var Mr = Ir(function(t2, e2, n2, r2, i2) {
  return t2.h === 2 && (Yn(t2, gn(e2, r2, n2), i2), true);
}, Fr);
...
function jr(t2, e2, n2, r2) {
  ...
  (i2 = {}).qa = r2, i2.T = function(t3) {
    switch (typeof t3) {
      case "boolean":
        return Pe ||= [0, undefined, true];
      case "number":
        return t3 > 0 ? undefined : t3 === 0 ? Ce ||= [0, undefined] : [-t3, undefined];
      case "string":
        return [0, t3];
      case "object":
        return t3;
  ...
  var s2 = r2[1];
  let o2 = 1;
  s2 && s2.constructor === Object && (i2.ba = s2, typeof (s2 = r2[++o2]) == "function" && (i2.ma = true, Br ??= s2, Gr ??= r2[o2 + 1], s2 = r2[o2 += 2]));
  const a2 = {};
...
function Vr(t2) {
  return Array.isArray(t2) ? t2[0] instanceof Rr ? t2 : [Pr, t2] : [t2, undefined];
}
function Xr(t2, e2) {
  return t2 instanceof Lr ? t2.v : Array.isArray(t2) ? Ne(t2, e2) : undefined;
}
...
function zr(t2) {
  ...
  return e2 = n2.ma ? (t3, e3) => Br(t3, e3, n2) : (t3, e3) => {
    for (;zn(e3) && e3.h != 4; ) {
      ...
      if (i2 == null) {
        var s2 = n2.ba;
        s2 && (s2 = s2[r2]) && ((s2 = Yr(s2)) != null && (i2 = n2[r2] = s2));
      }
      if (i2 == null || !i2(e3, t3, r2)) {
        ...
        i2 = undefined, s2 = t3, o2 && ((i2 = s2[H] ?? (s2[H] = new xe))[r2] ?? (i2[r2] = [])).push(o2);
      }
    }
...
function Kr(t2, e2, n2, r2) {
  var i2 = this[Or];
  const s2 = this[Nr], o2 = Ne(undefined, i2.T), a2 = ke(t2);
  if (a2) {
    ...
    if (h2) {
      ...
      if (c2) {
        ...
        const i3 = pt(r3), s3 = (e3, s4) => {
          ...
          s4 != null && (r3 = Qe(t2, r3, e3, s4, i3)), delete a2[e3];
        };
        e2 == null ? ft(o2, 0 | o2[Q], (t3, e3) => {
          s3(t3, e3);
        }) : s3(e2, Je(o2, e2, i3));
      }
    }
...
var ii = Ir(function(t2, e2, n2, r2, i2) {
  if (t2.h !== 2)
    return false;
  if (t2 = Vt(t2 = Yn(t2, Ne([undefined, undefined], r2), i2)), i2 = pt(r2 = 0 | e2[Q]), 2 & r2)
    throw Error();
  let s2 = Je(e2, n2, i2);
  if (s2 instanceof Ee)
    (2 & s2.J) != 0 ? (s2 = s2.V(), s2.push(t2), Qe(e2, r2, n2, s2, i2)) : s2.Ma(t2);
...
function si(t2, e2, n2) {
  (e2 = $t(e2)) != null && (lr(t2, n2, 5), t2 = t2.g, Pt(e2), hr(t2));
}
...
function ai(t2, e2, n2) {
  (e2 = ee(e2)) != null && e2 != null && (lr(t2, n2, 0), cr(t2.g, e2));
}
function ci(t2, e2, n2) {
  (e2 = Zt(e2)) != null && (lr(t2, n2, 0), t2.g.g.push(e2 ? 1 : 0));
}
function hi(t2, e2, n2) {
  (e2 = le(e2)) != null && pr(t2, n2, h(e2));
}
function ui(t2, e2, n2, r2, i2) {
  gr(t2, n2, Xr(e2, r2), i2);
}
function li(t2, e2, n2) {
  (e2 = e2 == null || typeof e2 == "string" || e2 instanceof F ? e2 : undefined) != null && pr(t2, n2, Pn(e2, true).buffer);
}
function fi(t2, e2, n2) {
  (e2 = ne(e2)) != null && e2 != null && (lr(t2, n2, 0), ar(t2.g, e2));
}
function di(t2, e2, n2) {
  return (t2.h === 5 || t2.h === 2) && (e2 = un(e2, 0 | e2[Q], n2), t2.h == 2 ? Jn(t2, Dn, e2) : e2.push(Dn(t2.g)), true);
}
var pi = ei(function(t2, e2, n2) {
  return t2.h === 5 && (ri(e2, n2, Dn(t2.g)), true);
}, si, br);
var gi = ni(di, function(t2, e2, n2) {
  if ((e2 = ti($t, e2)) != null)
    for (let o2 = 0;o2 < e2.length; o2++) {
      var r2 = t2, i2 = n2, s2 = e2[o2];
      s2 != null && (lr(r2, i2, 5), r2 = r2.g, Pt(s2), hr(r2));
    }
}, br);
var mi = ni(di, function(t2, e2, n2) {
  if ((e2 = ti($t, e2)) != null && e2.length) {
...
var yi = ei(function(t2, e2, n2) {
  return t2.h === 5 && (ri(e2, n2, (t2 = Dn(t2.g)) === 0 ? undefined : t2), true);
}, si, br);
var _i = ei(function(t2, e2, n2) {
  return t2.h !== 0 ? t2 = false : (ri(e2, n2, Cn(t2.g, Nt)), t2 = true), t2;
}, oi, Tr);
var vi = ei(function(t2, e2, n2) {
  return t2.h !== 0 ? e2 = false : (ri(e2, n2, (t2 = Cn(t2.g, Nt)) === Qr ? undefined : t2), e2 = true), e2;
}, oi, Tr);
var Ei = ei(function(t2, e2, n2) {
  return t2.h !== 0 ? t2 = false : (ri(e2, n2, Cn(t2.g, Ot)), t2 = true), t2;
}, function(t2, e2, n2) {
  if (e2 = function(t3) {
    if (t3 == null)
      return t3;
    ...
    if (te(t3)) {
      if (e3 === "string")
        return e3 = Kt(Number(t3)), Wt(e3) && e3 >= 0 ? t3 = String(e3) : ((e3 = t3.indexOf(".")) !== -1 && (t3 = t3.substring(0, e3)), (e3 = t3[0] !== "-" && ((e3 = t3.length) < 20 || e3 === 20 && t3 <= "18446744073709551615")) || (Gt(t3), t3 = Ut(Rt, It))), t3;
      if (e3 === "number")
...
var wi = ei(function(t2, e2, n2) {
  return t2.h === 0 && (ri(e2, n2, Nn(t2.g)), true);
}, ai, Er);
var Ti = ni(function(t2, e2, n2) {
  return (t2.h === 0 || t2.h === 2) && (e2 = un(e2, 0 | e2[Q], n2), t2.h == 2 ? Jn(t2, Nn, e2) : e2.push(Nn(t2.g)), true);
}, function(t2, e2, n2) {
  if ((e2 = ti(ee, e2)) != null && e2.length) {
    n2 = fr(t2, n2);
...
var Ai = ei(function(t2, e2, n2) {
  return t2.h === 0 && (ri(e2, n2, (t2 = Nn(t2.g)) === 0 ? undefined : t2), true);
}, ai, Er);
var bi = ei(function(t2, e2, n2) {
  return t2.h === 0 && (ri(e2, n2, On(t2.g)), true);
}, ci, _r);
var ki = ei(function(t2, e2, n2) {
  return t2.h === 0 && (ri(e2, n2, (t2 = On(t2.g)) === false ? undefined : t2), true);
}, ci, _r);
var Si = ni(function(t2, e2, n2) {
  return t2.h === 2 && (t2 = qn(t2), un(e2, 0 | e2[Q], n2).push(t2), true);
}, function(t2, e2, n2) {
  if ((e2 = ti(le, e2)) != null)
    for (let o2 = 0;o2 < e2.length; o2++) {
      var r2 = t2, i2 = n2, s2 = e2[o2];
      s2 != null && pr(r2, i2, h(s2));
    }
}, vr);
var xi = ei(function(t2, e2, n2) {
  return t2.h === 2 && (ri(e2, n2, (t2 = qn(t2)) === "" ? undefined : t2), true);
}, hi, vr);
var Li = ei(function(t2, e2, n2) {
  return t2.h === 2 && (ri(e2, n2, qn(t2)), true);
}, hi, vr);
var Ri = function(t2, e2, n2 = yr) {
  return new Rr(t2, e2, n2);
}(function(t2, e2, n2, r2, i2) {
  return t2.h === 2 && (r2 = Ne(undefined, r2), un(e2, 0 | e2[Q], n2).push(r2), Yn(t2, r2, i2), true);
}, function(t2, e2, n2, r2, i2) {
  if (Array.isArray(e2)) {
    for (let s2 = 0;s2 < e2.length; s2++)
...
var Fi = ei(function(t2, e2, n2) {
  return t2.h === 2 && (ri(e2, n2, $n(t2)), true);
}, li, kr);
var Mi = ni(function(t2, e2, n2) {
  return (t2.h === 0 || t2.h === 2) && (e2 = un(e2, 0 | e2[Q], n2), t2.h == 2 ? Jn(t2, Un, e2) : e2.push(Un(t2.g)), true);
}, function(t2, e2, n2) {
  if ((e2 = ti(ne, e2)) != null)
    for (let o2 = 0;o2 < e2.length; o2++) {
      var r2 = t2, i2 = n2, s2 = e2[o2];
      s2 != null && (lr(r2, i2, 0), ar(r2.g, s2));
    }
}, wr);
var Pi = ei(function(t2, e2, n2) {
  return t2.h === 0 && (ri(e2, n2, (t2 = Un(t2.g)) === 0 ? undefined : t2), true);
}, fi, wr);
var Ci = ei(function(t2, e2, n2) {
  return t2.h === 0 && (ri(e2, n2, Nn(t2.g)), true);
}, function(t2, e2, n2) {
  (e2 = ee(e2)) != null && (e2 = parseInt(e2, 10), lr(t2, n2, 0), cr(t2.g, e2));
}, Sr);

class Oi {
  constructor(t2, e2) {
    var n2 = Qi;
    this.g = t2, this.h = e2, this.m = yn, this.j = wn, this.defaultValue = undefined, this.l = n2.Oa != null ? dt : undefined;
  }
  register() {
    m(this);
  }
...
function Ui(t2, e2) {
  return (n2, r2) => {
    {
      const s2 = { ea: true };
      r2 && Object.assign(s2, r2), n2 = Hn(n2, undefined, undefined, s2);
      try {
...
var Gi = [0, xi, ei(function(t2, e2, n2) {
  return t2.h === 2 && (ri(e2, n2, (t2 = $n(t2)) === R() ? undefined : t2), true);
}, function(t2, e2, n2) {
  if (e2 != null) {
    if (e2 instanceof Lr) {
      const r2 = e2.Ra;
      return void (r2 ? (e2 = r2(e2), e2 != null && pr(t2, n2, Pn(e2, true).buffer)) : U(K, 3));
    }
    if (Array.isArray(e2))
      return void U(K, 3);
  }
...
function Xi(t2) {
  var e2;
  return ji === undefined && (ji = function() {
    let t3 = null;
    if (!Vi)
      return t3;
    try {
...
var Ki = [0, bi, Li, bi, Ci, -1, ni(function(t2, e2, n2) {
  return (t2.h === 0 || t2.h === 2) && (e2 = un(e2, 0 | e2[Q], n2), t2.h == 2 ? Jn(t2, Bn, e2) : e2.push(Nn(t2.g)), true);
}, function(t2, e2, n2) {
  if ((e2 = ti(ee, e2)) != null && e2.length) {
    n2 = fr(t2, n2);
    for (let n3 = 0;n3 < e2.length; n3++)
...
var Yi = [0, 3, bi, -1, 2, [0, [2], wi, Ii, [0, ei(function(t2, e2, n2) {
  return t2.h === 0 && (ri(e2, n2, Un(t2.g)), true);
...
var Ms = class extends Lr {
  ...
  na() {
    const t2 = $e(this, 1, undefined, undefined, an);
    return t2 == null ? R() : t2;
  }
};
var Ps = class extends Lr {
...
var Vs = class extends Lr {
  ...
  g() {
    return $e(this, 1, undefined, undefined, an) != null;
  }
  l() {
    return le($e(this, 2)) != null;
  }
};
...
var xo = Ni(458105876, class extends Lr {
  ...
  g() {
    ...
    return t2 = at(this, n2), e2 = function(t3, e3, n3, r2) {
      ...
      return !t3 && 32 & n3 && nt(s2, 32), n3 = Qe(e3, n3, 2, r2 = new Ee(s2, i2, de, undefined)), t3 || ze(e3, n3), r2;
...
function Bo(t2, e2) {
  return e2 = e2 ? e2.clone() : new Ns, t2.displayNamesLocale !== undefined ? Ze(e2, 1, ue(t2.displayNamesLocale)) : t2.displayNamesLocale === undefined && Ze(e2, 1), t2.maxResults !== undefined ? xn(e2, 2, t2.maxResults) : ("maxResults" in t2) && Ze(e2, 2), t2.scoreThreshold !== undefined ? Ln(e2, 3, t2.scoreThreshold) : ("scoreThreshold" in t2) && Ze(e2, 3), t2.categoryAllowlist !== undefined ? In(e2, 4, t2.categoryAllowlist) : ("categoryAllowlist" in t2) && Ze(e2, 4), t2.categoryDenylist !== undefined ? In(e2, 5, t2.categoryDenylist) : ("categoryDenylist" in t2) && Ze(e2, 5), e2;
}
function Go(t2) {
  const e2 = Number(t2);
...
function Vo(t2) {
  ...
  return function(t3) {
    return t3 == null ? t3 : typeof t3 == "bigint" ? (wt(t3) ? t3 = Number(t3) : (t3 = Xt(64, t3), t3 = wt(t3) ? Number(t3) : String(t3)), t3) : te(t3) ? typeof t3 == "number" ? ie(t3) : se(t3) : undefined;
  }($e(t2, 2, undefined, undefined, ce)) != null && (e2.timestampMs = Go($e(t2, 2, undefined, undefined, ce) ?? Ye)), e2;
}
function Xo(t2) {
  ...
  if ((e2 = yn(t2, Es, 4)?.l()) && (s2.boundingBox = { originX: kn(e2, 1, qe) ?? 0, originY: kn(e2, 2, qe) ?? 0, width: kn(e2, 3, qe) ?? 0, height: kn(e2, 4, qe) ?? 0, angle: 0 }), yn(t2, Es, 4)?.g().length)
    for (const e3 of yn(t2, Es, 4).g())
      s2.keypoints.push({ x: $e(e3, 1, undefined, qe, $t) ?? 0, y: $e(e3, 2, undefined, qe, $t) ?? 0, score: $e(e3, 4, undefined, qe, $t) ?? 0, label: le($e(e3, 3, undefined, qe)) ?? "" });
  return s2;
}
function Ho(t2) {
  const e2 = [];
...
async function ta(t2) {
  ...
  try {
      ...
      throw e2;
    {
      ...
      e3 ? await e3(t2.toString()) : await import(/* @vite-ignore */ t2.toString());
    }
  }
}
function ea(t2) {
...
function ca(t2, e2) {
  ...
  typeof e2 == "string" ? (Ze(n2, 2, ue(e2)), Ze(n2, 1)) : e2 instanceof Uint8Array && (Ze(n2, 1, ht(e2, false)), Ze(n2, 2)), wn(t2.baseOptions, 0, 1, n2);
}
function ha(t2) {
  try {
...
var pa = class {
  ...
  l(t2, e2 = true) {
    if (e2) {
      ...
      if (function(t3, e4) {
        ...
        "delegate" in e4 && (e4.delegate === "GPU" ? (e4 = n2, r2 = new zi, Tn(e4, 2, js, r2)) : (e4 = n2, r2 = new $i, Tn(e4, 4, js, r2))), wn(t3.baseOptions, 0, 3, n2);
  ...
  setGraph(t2, e2) {
    ...
    }), this.g.Ja(), this.g.setGraph(t2, e2), this.B = undefined, ha(this);
  }
  finishProcessing() {
...
var Na = class {
  constructor(t2, e2, n2, r2, i2, s2, o2) {
    this.g = t2, this.m = e2, this.j = n2, this.canvas = r2, this.l = i2, this.width = s2, this.height = o2, this.j && (--Ua === 0 && console.error("You seem to be creating MPMask instances without invoking .close(). This leaks resources."));
  }
  Fa() {
    return !!xa(this, 0);
  }
...
var nc = class {
  constructor(t2, e2, n2, r2, i2, s2, o2) {
    this.g = t2, this.j = e2, this.m = n2, this.canvas = r2, this.l = i2, this.width = s2, this.height = o2, (this.j || this.m) && (--rc === 0 && console.error("You seem to be creating MPImage instances without invoking .close(). This leaks resources."));
  }
  Ea() {
    return !!Ya(this, 0);
  }
...
var sc = function(t2) {
  ...
  constructor(t2, e2) {
    this.l = true, this.i = t2, this.g = null, this.h = 0, this.m = typeof this.i._addIntToInputStream == "function", e2 !== undefined ? this.i.canvas = e2 : Qo() ? this.i.canvas = new OffscreenCanvas(1, 1) : (console.warn("OffscreenCanvas not supported and GraphRunner constructor glCanvas parameter is undefined. Creating backup canvas."), this.i.canvas = document.createElement("canvas"));
  }
...
async function cc(t2, e2, n2) {
  ...
  }(t2, n2.canvas ?? (Qo() ? undefined : document.createElement("canvas")), e2, n2);
}
...
var dc = class extends pa {
  ...
  l(t2, e2 = true) {
    if ("runningMode" in t2 && Ze(this.baseOptions, 2, Jt(!!t2.runningMode && t2.runningMode !== "IMAGE")), t2.canvas !== undefined && this.g.i.canvas !== t2.canvas)
...
function Ic(t2, e2 = true) {
  ...
  for (const i2 of t2) {
    ...
    for (const n3 of r2.g())
      r2 = e2 && kn(n3, 1) != null ? kn(n3, 1) ?? 0 : -1, t2.push({ score: Sn(n3, 2) ?? 0, index: r2, categoryName: le($e(n3, 3)) ?? "" ?? "", displayName: le($e(n3, 4)) ?? "" ?? "" });
    n2.push(t2);
  }
  return n2;
}
var Fc = class extends dc {
  ...
  o(t2) {
    if (xn(this.A, 3, t2.numHands ?? 1), "minHandDetectionConfidence" in t2 && Ln(this.A, 2, t2.minHandDetectionConfidence ?? 0.5), "minTrackingConfidence" in t2 && Ln(this.u, 4, t2.minTrackingConfidence ?? 0.5), "minHandPresenceConfidence" in t2 && Ln(this.D, 2, t2.minHandPresenceConfidence ?? 0.5), t2.cannedGesturesClassifierOptions) {
      ...
      t2.cannedGesturesClassifierOptions === undefined && yn(this.h, to, 3)?.g();
    return t2.customGesturesClassifierOptions ? (wn(n2 = e2 = new to, 0, 2, r2 = Bo(t2.customGesturesClassifierOptions, yn(this.h, to, 4)?.l())), wn(this.h, 0, 4, e2)) : t2.customGesturesClassifierOptions === undefined && yn(this.h, to, 4)?.g(), this.l(t2);
  }
  Ha(t2, e2) {
...
var Dc = class extends dc {
  ...
  F(t2, e2, n2) {
    ...
    return this.D = typeof e2 == "function" ? e2 : n2, Oc(this), uc(this, t2, r2), Nc(this);
  }
  G(t2, e2, n2, r2) {
    const i2 = typeof n2 != "function" ? n2 : {};
    return this.D = typeof n2 == "function" ? n2 : r2, Oc(this), lc(this, t2, i2, e2), Nc(this);
  }
  m() {
    var t2 = new ls;
    ...
    Rn(n2, 1, "type.googleapis.com/mediapipe.tasks.vision.holistic_landmarker.proto.HolisticLandmarkerGraphOptions"), function(t3, e3) {
      if (e3 != null)
        if (Array.isArray(e3))
          ...
          if (!(typeof e3 == "string" || e3 instanceof F || x(e3)))
...
var Gc = class extends dc {
  ...
  o(t2) {
    ...
    return n2 = n2 ? n2.clone() : new Ds, t2.l2Normalize !== undefined ? Ze(n2, 1, Jt(t2.l2Normalize)) : ("l2Normalize" in t2) && Ze(n2, 1), t2.quantize !== undefined ? Ze(n2, 2, Jt(t2.quantize)) : ("quantize" in t2) && Ze(n2, 2), wn(e2, 0, 2, n2), this.l(t2);
  }
  za(t2, e2) {
    ...
    Rn(n2, 2, "mediapipe.tasks.vision.image_embedder.ImageEmbedderGraph"), ns(n2, "IMAGE:image_in"), ns(n2, "NORM_RECT:norm_rect"), rs(n2, "EMBEDDINGS:embeddings_out"), n2.o(e2), cs(t2, n2), this.g.attachProtoListener("embeddings_out", (t3, e3) => {
      t3 = Os(t3), this.embeddings = function(t4) {
        return { embeddings: vn(t4, Ps, 1).map((t5) => {
          ...
          var n3 = t5.v;
          return mn(n3, 0 | n3[Q], Fs, ln(t5, 1)) !== undefined ? (t5 = en(t5 = yn(t5, Fs, ln(t5, 1), undefined), 1, $t, tn()), e4.floatEmbedding = t5.slice()) : (n3 = new Uint8Array(0), e4.quantizedEmbedding = yn(t5, Ms, ln(t5, 2), undefined)?.na()?.h() ?? n3), e4;
        }), timestampMs: Go($e(t4, 2, undefined, undefined, ce) ?? Ye) };
      }(t3), ua(this, e3);
...
function Vc(t2) {
  ...
  e2.length === 1 && (yn(e2[0], Qi, 7)?.j()?.g() ?? new Map).forEach((e3, n2) => {
...
var Wc = class extends dc {
  ...
  o(t2) {
    return t2.displayNamesLocale !== undefined ? Ze(this.h, 2, ue(t2.displayNamesLocale)) : ("displayNamesLocale" in t2) && Ze(this.h, 2), "outputCategoryMask" in t2 && (this.outputCategoryMask = t2.outputCategoryMask ?? false), "outputConfidenceMasks" in t2 && (this.outputConfidenceMasks = t2.outputConfidenceMasks ?? true), super.l(t2);
  }
  L() {
    Vc(this);
  }
  segment(t2, e2, n2) {
    const r2 = typeof e2 != "function" ? e2 : {};
    return this.j = typeof e2 == "function" ? e2 : n2, Xc(this), uc(this, t2, r2), Hc(this);
  }
  La(t2, e2, n2, r2) {
    const i2 = typeof n2 != "function" ? n2 : {};
    return this.j = typeof n2 == "function" ? n2 : r2, Xc(this), lc(this, t2, i2, e2), Hc(this);
  }
  Da() {
    return this.u;
  }
  m() {
    ...
    Rn(n2, 2, "mediapipe.tasks.vision.image_segmenter.ImageSegmenterGraph"), ns(n2, "IMAGE:image_in"), ns(n2, "NORM_RECT:norm_rect"), n2.o(e2), cs(t2, n2), la(this, t2), this.outputConfidenceMasks && (us(t2, "confidence_masks"), rs(n2, "CONFIDENCE_MASKS:confidence_masks"), fa(this, "confidence_masks"), this.g.aa("confidence_masks", (t3, e3) => {
      ...
      this.categoryMask = undefined, ua(this, t3);
...
var Kc = class extends dc {
  ...
  segment(t2, e2, n2, r2) {
    const i2 = typeof n2 != "function" ? n2 : {};
    if (this.j = typeof n2 == "function" ? n2 : r2, this.qualityScores = this.categoryMask = this.confidenceMasks = undefined, n2 = this.C + 1, r2 = new Po, e2.keypoint && e2.scribble)
...
var Yc = class extends dc {
  ...
  o(t2) {
    return t2.displayNamesLocale !== undefined ? Ze(this.h, 2, ue(t2.displayNamesLocale)) : ("displayNamesLocale" in t2) && Ze(this.h, 2), t2.maxResults !== undefined ? xn(this.h, 3, t2.maxResults) : ("maxResults" in t2) && Ze(this.h, 3), t2.scoreThreshold !== undefined ? Ln(this.h, 4, t2.scoreThreshold) : ("scoreThreshold" in t2) && Ze(this.h, 4), t2.categoryAllowlist !== undefined ? In(this.h, 5, t2.categoryAllowlist) : ("categoryAllowlist" in t2) && Ze(this.h, 5), t2.categoryDenylist !== undefined ? In(this.h, 6, t2.categoryDenylist) : ("categoryDenylist" in t2) && Ze(this.h, 6), this.l(t2);
  }
  F(t2, e2) {
    return this.j = { detections: [] }, uc(this, t2, e2), this.j;
  }
...
var Zc = class extends dc {
  ...
  F(t2, e2, n2) {
    const r2 = typeof e2 != "function" ? e2 : {};
    return this.u = typeof e2 == "function" ? e2 : n2, $c(this), uc(this, t2, r2), Jc(this);
  }
  G(t2, e2, n2, r2) {
    const i2 = typeof n2 != "function" ? n2 : {};
    return this.u = typeof n2 == "function" ? n2 : r2, $c(this), lc(this, t2, i2, e2), Jc(this);
  }
  m() {
    var t2 = new ls;
...
var poseLandmarker;
var lastVideoTime = -1;
var soundSuccess = new Audio("./sounds/success.mp3");
soundSuccess.volume = 0.75;
var soundWarning = new Audio("./sounds/warning.mp3");
var pushUpCount = 0;
var isDown = false;
var badPostureStartTime = null;
var warningAudioPlayed = false;
function playSuccessSound() {
  soundSuccess.currentTime = 0;
  soundSuccess.play().catch(() => {});
}
function calculatePixelAngle(a2, b2, c2) {
  const radians = Math.atan2(c2.y - b2.y, c2.x - b2.x) - Math.atan2(a2.y - b2.y, a2.x - b2.x);
  let angle = Math.abs(radians * 180 / Math.PI);
  if (angle > 180)
    angle = 360 - angle;
  return angle;
}
function analyzePostureAndMotion(landmarks) {
    ...
    if (postureColor === "#FF0000") {
      if (badPostureStartTime === null) {
        ...
        if (!warningAudioPlayed) {
          soundWarning.play().catch((e2) => console.log("Audio bloqué:", e2));
...
function predictWebcam() {
  ...
  if (lastVideoTime !== video.currentTime) {
    ...
    if (results.landmarks && results.landmarks.length > 0) {
      ...
      drawConnectors(landmarks, Zc.POSE_CONNECTIONS, currentStatusColor);
      drawLandmarks(landmarks, currentStatusColor);
    }
  }
  requestAnimationFrame(predictWebcam);
}
function drawConnectors(landmarks, connections, color) {
